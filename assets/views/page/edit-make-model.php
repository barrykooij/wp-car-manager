	...
	<form method="post" action="<?php echo admin_url( 'edit.php?post_type=wpcm_vehicle&page=wpcm-makes' ); ?>">
		...
		<table class="form-table">
			...
			<tr class="form-field form-required term-name-wrap">
				...
				<td><input name="name" id="name" type="text" value="<?php echo $item['name']; ?>" size="40"
				           aria-required="true">
			...
			<tr class="form-field term-slug-wrap">
				...
				<td><input name="slug" id="slug" type="text" value="<?php echo $item['slug']; ?>" size="40">

					<p class="description"><?php _e( 'The “slug” is the URL-friendly version of the name. It is usually all
						lowercase and contains only letters, numbers, and hyphens.' ); ?></p></td>
			</tr>
			</tbody>
		</table>
