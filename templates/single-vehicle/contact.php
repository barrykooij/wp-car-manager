...
<div class="wpcm-contact">
	...
	<a href="mailto:<?php echo wp_car_manager()->service( 'settings' )->get_option( 'contact_email' ); ?>?subject=<?php the_title(); ?>" class="wpcm-contact-button"><?php _e( 'Email Us', 'wp-car-manager' ); ?></a>
	<?php
